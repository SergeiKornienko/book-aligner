"""AI-based alignment using string similarity."""

from typing import List, Tuple
from backend.services.models import TextFragment
from backend.services.alignment.matching import find_best_match
...
def align_with_ai(
    ...
    for donor_frag in donor_fragments:
        ...
        best_match, score = find_best_match(donor_frag, available_samples)
